...
var require_ms = __commonJS({
  "node_modules/@kwsites/file-exists/node_modules/ms/index.js"(exports, module2) {
    var s = 1e3;
    var m = s * 60;
    var h = m * 60;
    var d = h * 24;
...
var require_common = __commonJS({
  "node_modules/@kwsites/file-exists/node_modules/debug/src/common.js"(exports, module2) {
    function setup(env) {
...
var require_browser = __commonJS({
  "node_modules/@kwsites/file-exists/node_modules/debug/src/browser.js"(exports, module2) {
...
var require_node = __commonJS({
  "node_modules/@kwsites/file-exists/node_modules/debug/src/node.js"(exports, module2) {
    var tty = require("tty");
...
var require_src = __commonJS({
  "node_modules/@kwsites/file-exists/node_modules/debug/src/index.js"(exports, module2) {
...
var require_src2 = __commonJS({
  "node_modules/@kwsites/file-exists/dist/src/index.js"(exports) {
    ...
    function check2(path2, isFile, isDirectory) {
    ...
    function exists2(path2, type = exports.READABLE) {
      return check2(path2, (type & exports.FILE) > 0, (type & exports.FOLDER) > 0);
    }
...
var require_ms2 = __commonJS({
  "node_modules/simple-git/node_modules/ms/index.js"(exports, module2) {
    var s = 1e3;
    var m = s * 60;
    var h = m * 60;
    var d = h * 24;
...
var require_common2 = __commonJS({
  "node_modules/simple-git/node_modules/debug/src/common.js"(exports, module2) {
    function setup(env) {
      createDebug.debug = createDebug;
      createDebug.default = createDebug;
      createDebug.coerce = coerce;
...
var require_browser2 = __commonJS({
  "node_modules/simple-git/node_modules/debug/src/browser.js"(exports, module2) {
    exports.formatArgs = formatArgs;
    exports.save = save;
    exports.load = load2;
    exports.useColors = useColors;
...
var require_node2 = __commonJS({
  "node_modules/simple-git/node_modules/debug/src/node.js"(exports, module2) {
    var tty = require("tty");
    var util = require("util");
    exports.init = init;
    exports.log = log;
...
var require_src3 = __commonJS({
  "node_modules/simple-git/node_modules/debug/src/index.js"(exports, module2) {
    if (typeof process === "undefined" || process.type === "renderer" || process.browser === true || process.__nwjs) {
...
var require_figures = __commonJS({
  "node_modules/figures/index.js"(exports, module2) {
    ...
    module2.exports = Object.assign(fn, figures4);
...
function trailingArrayArgument(args2) {
  ...
  return filterType(last(args2, hasTrailingCallback ? 1 : 0), filterArray, []);
}
...
function parseStringResponse(result, parsers12, texts, trim = true) {
  asArray(texts).forEach((text) => {
    for (let lines2 = toLinesWithContent(text, trim), i = 0, max = lines2.length; i < max; i++) {
      const line = (offset = 0) => {
        if (i + offset >= max) {
          return;
        }
...
function* configParser(text, requestedKey = null) {
  const lines2 = text.split("\0");
  for (let i = 0, max = lines2.length - 1; i < max; ) {
    ...
    GitExecutorChain = class {
      ...
      attemptRemoteTask(task, logger) {
        return __async(this, null, function* () {
          ...
          const raw = yield this.gitResponse(task, this.binary, args2, this.outputHandler, logger.step("SPAWN"));
      ...
      handleTaskData(task, args2, result, logger) {
        ...
        return new Promise((done, fail) => {
          ...
          const { error } = this._plugins.exec("task.error", { error: rejection }, __spreadValues(__spreadValues({}, pluginContext(task, args2)), result));
      ...
      gitResponse(task, command, args2, outputHandler, logger) {
        return __async(this, null, function* () {
          ...
          return new Promise((done) => {
            ...
            const spawned = (0, import_child_process.spawn)(command, args2, spawnOptions);
...
var init_parse_commit = __esm({
  "src/lib/parsers/parse-commit.ts"() {
    ...
    parsers = [
      ...
      new LineParser(/^(\d+)[^,]*(?:,\s*(\d+)[^(]+\(([+-]))?/, (result, [changes, lines2, direction]) => {
        result.summary.changes = parseInt(changes, 10) || 0;
        const count = parseInt(lines2, 10) || 0;
        if (direction === "-") {
...
function lines({ items, width, renderItem: renderItem3, active, position: requested, pageSize }) {
  ...
  const renderItemAt = (index) => split(renderItem3(layoutsInPage[index]), width);
...
// node_modules/@inquirer/core/dist/esm/lib/pagination/use-pagination.mjs
function usePagination({ items, active, renderItem: renderItem3, pageSize = 7, loop = true }) {
...
function renderItem({ item, isActive }) {
  ...
  const checkbox = item.checked ? import_chalk4.default.green(import_figures2.default.circleFilled) : import_figures2.default.circle;
...
var esm_default2 = createPrompt((config, done) => {
  const { prefix = usePrefix(), instructions, pageSize, loop = true, choices: choices3 } = config;
  const [status, setStatus] = useState("pending");
  const [items, setItems] = useState(choices3.map((choice) => ({ ...choice })));
  const bounds = useMemo(() => {
    const first2 = items.findIndex(isSelectable);
    const last2 = items.length - 1 - [...items].reverse().findIndex(isSelectable);
    if (first2 < 0) {
  ...
  if (status === "done") {
    const selection = items.filter(isChecked).map((choice) => choice.name || choice.value);
    return `${prefix} ${message} ${import_chalk4.default.cyan(selection.join(", "))}`;
  }
  let helpTip = "";
  if (showHelpTip && (instructions === void 0 || instructions)) {
    if (typeof instructions === "string") {
      ...
      const keys = [
        `${import_chalk4.default.cyan.bold("<space>")} to select`,
        `${import_chalk4.default.cyan.bold("<a>")} to toggle all`,
        `${import_chalk4.default.cyan.bold("<i>")} to invert selection`,
        `and ${import_chalk4.default.cyan.bold("<enter>")} to proceed`
      ];
      helpTip = ` (Press ${keys.join(", ")})`;
    }
  }
  return `${prefix} ${message}${helpTip}
${page}${import_ansi_escapes2.default.cursorHide}`;
});
...
function renderItem2({ item, isActive }) {
  if (Separator.isSeparator(item)) {
    return ` ${item.separator}`;
  }
  const line = item.name || item.value;
  ...
  const prefix = isActive ? import_figures3.default.pointer : ` `;
...
var esm_default3 = createPrompt((config, done) => {
  ...
  const [status, setStatus] = useState("pending");
  const bounds = useMemo(() => {
    const first2 = items.findIndex(isSelectable2);
    const last2 = items.length - 1 - [...items].reverse().findIndex(isSelectable2);
    if (first2 < 0)
...
// src/packages/react-choices.ts
var choices = [{ name: "Zustand", value: "zustand" }];
var react_choices_default = choices;

// src/packages/express-choices.ts
var choices2 = [
...
var express_choices_default = choices2;

// src/app.ts
var path = require("path");
var currentDir = __dirname;
var os = process.platform;
var npmCommand = os === "win32" ? "npm.cmd" : "npm";
var args = process.argv.slice(2);
console.clear();
console.log("\x1B[33m\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\x1B[37m");
console.log("           \x1B[33m\x1B[1m\x1B[37mCronos \u{1F525}  \x1B[0m\x1B[31m");
console.log(
...
var main = async () => {
  ...
  if (name !== ".") {
    import_fs.default.mkdirSync(route);
    process.chdir(route);
  }
  ...
  try {
    if (args.includes("--experimental-no-git")) {
      console.log("\u{1F6AB} Using local templates");
      ...
      await esm_default().clone(`https://github.com/cronos-js/cronos.${tech}`, ".");
    }
  } catch (error) {
    console.log(error);
    console.log("  \u{1F628} An error occurred while creating the project.\n");
  }
  console.clear();
  try {
